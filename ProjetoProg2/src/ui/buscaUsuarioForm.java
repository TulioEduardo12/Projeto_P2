 ...
 * @author Matheus Dino
 */
public class buscaUsuarioForm extends javax.swing.JFrame {

    Connection conec = null;
    ResultSet rs = null;
    PreparedStatement pst = null;
    
    public buscaUsuarioForm() {
        initComponents();
    ...
    private void botaoVoltarInfosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_botaoVoltarInfosMouseClicked
        usuarioCadastroForm cadForm = new usuarioCadastroForm();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buscaUsuarioForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new buscaUsuarioForm().setVisible(true);
            }
        });
    }
